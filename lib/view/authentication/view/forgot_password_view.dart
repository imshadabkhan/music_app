...
import 'package:music_app/view/authentication/view/verification_view.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Texts.textBold("Forget Password",size: 18),elevation: 0,scrolledUnderElevation: 0,backgroundColor: ColorConstants.whiteColor,centerTitle: true,),
