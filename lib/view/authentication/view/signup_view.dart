...
class SignUpView extends StatelessWidget {
  ...
  formSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Center(child:Texts.textBold("Sign Up",
            color: ColorConstants.blackColor,
            size: 24,
        ...
        Row(
          children: [
            Obx(
              () => Expanded(
                child: CustomButton(
                  icon: Image.asset(Assets.guitarIcon,height: 20,),
                  label: "Musician",
            ...
            Obx(
              () => Expanded(
                child: CustomButton(
                  icon: Image.asset(Assets.clientIcon,height: 20,),
                  label: "Client",
                  textColor: !authenticationController.isHostSelected.value
                      ? Colors.black45
                      : ColorConstants.redColor,
        ...
        Row(
          ...
          children: [
            Obx(()=>  SizedBox(
              ...
              width: 20.w,
              child: Checkbox(
                value:authenticationController.checkboxValue.value,onChanged: (value){
            ...
            Widgets.widthSpaceW2,
            Texts.textNormal("Agree to terms & conditions",size:12,color: ColorConstants.greyTextColor)
          ],),
        Widgets.heightSpaceH3,
        CustomButton(
          label: "Register",
