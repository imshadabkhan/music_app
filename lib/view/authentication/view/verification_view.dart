...
import 'package:music_app/view/authentication/view/reset_password_view.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: ColorConstants.whiteColor,
          centerTitle: true,
          title:Texts.textBold('Verification',size: 18),
        ),
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                Texts.textNormal("Resend Code",size: 12,color: ColorConstants.blackColor,)
              ],),
